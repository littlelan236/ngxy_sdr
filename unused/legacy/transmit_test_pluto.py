if __name__ == "__main__":
    ...
    server_tx = zmqServerTx(address="tcp://127.0.0.1:2230") # port 2234
    decoder = frame_decoder("signal", on_frame_decoded=on_frame_decoded, zmq_address="tcp://127.0.0.1:2235", crc16_enabled=False) # port 2236
