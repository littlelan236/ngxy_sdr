...
class final_no_gui(gr.top_block):
    ...
    def __init__(self):
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('192.168.3.4' if '192.168.3.4' else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '666', True)
