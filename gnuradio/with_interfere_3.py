...
import sip
import threading
import with_interfere_3_epy_block_0_0 as epy_block_0_0  # embedded python block



class with_interfere_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "with_interfere_3")
        ...
        self.taps_lpf_pre = taps_lpf_pre = firdes.low_pass(1.0, samp_rate, 260000, 5000)
        ...
        self.iio_pluto_sink_0.set_attenuation(0, 55)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_taps_lpf_pre(firdes.low_pass(1.0, self.samp_rate, 260000, 5000))
    ...
    def set_signal_bandwidth(self, signal_bandwidth):
        ...
        self.iio_pluto_sink_0_0_0.set_bandwidth(self.signal_bandwidth)
    ...
    def set_fc_blue_3(self, fc_blue_3):
        ...
        self.iio_pluto_sink_0_0_0.set_frequency(self.fc_blue_3)
...
def main(top_block_cls=with_interfere_3, options=None):
