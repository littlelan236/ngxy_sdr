...
import region_games_with_gui_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading



class region_games_with_gui(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=region_games_with_gui, options=None):
