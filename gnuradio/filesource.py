...
import filesource_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading
...
class filesource(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sensitivity_signal = sensitivity_signal = 1.5628
        self.sensitivity_inf_3 = sensitivity_inf_3 = 0.6517
        self.sensitivity_inf_2 = sensitivity_inf_2 = 2.5681
        self.sensitivity_inf_1 = sensitivity_inf_1 = 2.8194
        ...
        self.fft_filter_xxx_1_0_0 = filter.fft_filter_ccf(1, taps_lpf_pre, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/ubuntu/radar2026/radio26/rec/trimmed.iq', True, 0, 0)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.analog_quadrature_demod_cf_0_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.fft_filter_xxx_1_0_0, 0))
