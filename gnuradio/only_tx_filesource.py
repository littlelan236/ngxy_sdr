...
import only_tx_filesource_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading



class only_tx_filesource(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "only_tx_filesource")
        ...
        self.iio_pluto_source_0_0 = iio.fmcomms2_source_fc32('192.168.2.3' if '192.168.2.3' else iio.get_pluto_uri(), [True, True], 32768)
        self.iio_pluto_source_0_0.set_len_tag_key('packet_len')
        self.iio_pluto_source_0_0.set_frequency(fc_blue_1)
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('192.168.2.3' if '192.168.2.3' else iio.get_pluto_uri(), [True, True], 327680, False)
        self.iio_pluto_sink_0.set_len_tag_key('')
        self.iio_pluto_sink_0.set_bandwidth(1000000)
        self.iio_pluto_sink_0.set_frequency(fc_blue_1)
        ...
        self.connect((self.fft_filter_xxx_1_0_0, 0), (self.qtgui_freq_sink_x_0_0, 1))
        self.connect((self.iio_pluto_source_0_0, 0), (self.analog_quadrature_demod_cf_0_0, 0))
        self.connect((self.iio_pluto_source_0_0, 0), (self.fft_filter_xxx_1_0_0, 0))
        self.connect((self.iio_pluto_source_0_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
    ...
    def set_fc_blue_1(self, fc_blue_1):
        ...
        self.iio_pluto_sink_0.set_frequency(self.fc_blue_1)
        self.iio_pluto_source_0_0.set_frequency(self.fc_blue_1)
...
def main(top_block_cls=only_tx_filesource, options=None):
