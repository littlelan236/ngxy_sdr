...
class only_tx_filesource(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('192.168.2.3' if '192.168.2.3' else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('192.168.2.5' if '192.168.2.5' else iio.get_pluto_uri(), [True, True], 327680, True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\wangt\\Downloads\\RX_BLUE_ganrao_3', True, 0, 0)
